...
public OnPluginStart()
{
	...
	RegConsoleCmd("sm_damagesound-victim", Command_DamageSoundMenu, "Shows the damagesound menu");
	RegConsoleCmd("sm_hitsound-victim", Command_DamageSoundMenu, "Shows the damagesound menu");
	
	// Register Admin Commands
	RegAdminCmd("sm_damagesound-victim_test", Command_TestSound, ADMFLAG_ROOT, "Creates a hurt event of the game engine to test the damage sound");
